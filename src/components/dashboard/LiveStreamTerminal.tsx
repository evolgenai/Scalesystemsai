          ...
          <div className="flex items-center gap-1.5">
            ...
            {canResume ? (
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg border border-emerald-400/50 bg-emerald-400/15 px-2.5 py-1.5 text-[10px] font-semibold uppercase tracking-wide text-emerald-300 shadow-[0_0_18px_rgba(52,211,153,0.28)] transition hover:bg-emerald-400/25 disabled:cursor-not-allowed disabled:opacity-40"
