    ...
    >
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-lg px-3.5 py-2 text-xs font-semibold transition ${
          mode === "USER"
            ? "bg-emerald-600 text-white shadow-[0_0_24px_rgba(16, 185, 129,0.35)]"
      ...
      <div className="space-y-4 p-4 sm:p-5">
          ...
          {template.steps.map((_, i) => (
            <div
              ...
              className={`h-1 flex-1 rounded-full ${
                i <= step ? "bg-emerald-600" : "bg-white/10"
              }`}
            />
          ))}
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-emerald-400"
          >
            {isLast ? (
              <>
