...
function StdoutBlock({
  ...
  return (
    <pre
      className={`whitespace-pre-wrap rounded-lg border border-emerald-400/30 bg-[#03140c] px-3 py-2.5 font-mono text-[12px] leading-relaxed text-emerald-300 shadow-[0_0_24px_rgba(16, 185, 129,0.22)] ${
...
export default function SandboxConsole({
  ...
  return (
    <section
      className={`overflow-hidden rounded-xl border border-emerald-400/25 bg-[#050807] shadow-[0_0_28px_rgba(16, 185, 129,0.12)] ${
        compact ? "" : "mt-3"
      }`}
    >
