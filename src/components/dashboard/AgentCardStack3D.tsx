  ...
  return (
    <group onClick={onBackground}>
      ...
      <spotLight
        ...
        angle={0.5}
        penumbra={0.8}
        color={troubleshootActive ? "#f59e0b" : "#10B981"}
      />
    ...
    <div className="space-y-3">
      ...
      {showFlat ? (
        ...
        <WebGLErrorBoundary onError={() => setUse3d(false)}>
          ...
          >
            <div
              className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_center,rgba(16, 185, 129,0.06),transparent_70%)]"
              aria-hidden
            />
            <Canvas
