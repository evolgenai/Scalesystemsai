...
function MiniSparkline({ points, color = "#10B981" }: { points: number[]; color?: string }) {
...
export default function SreHealthMonitor() {
  ...
  const summaryStats = [
    { label: "Overall Health", value: overall === "healthy" ? "Operational" : overall === "degraded" ? "Degraded" : "Incident", icon: Shield, color: overall === "healthy" ? "#10B981" : overall === "degraded" ? "#fbbf24" : "#f87171" },
    ...
    { label: "Avg Error Rate", value: `${avgErrorRate}%`, icon: AlertTriangle, color: Number(avgErrorRate) > 1 ? "#fbbf24" : "#10B981" },
  ];
              ...
              {containers.map((c) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <MiniGauge value={c.cpu} label="CPU" color={c.cpu > 70 ? "#f87171" : c.cpu > 50 ? "#fbbf24" : "#10B981"} />
