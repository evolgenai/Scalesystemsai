  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-white/5 px-4 py-3.5">
        <div className="flex items-start gap-3">
          <Hover3DIcon intensity={12}>
            <span className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/[0.03]">
              <Radio className="h-4 w-4 text-blue-400" aria-hidden />
            </span>
          </Hover3DIcon>
          <div>
        ...
        {hydrated && savedUrl ? (
          <span className="rounded-md border border-blue-500/25 bg-blue-500/10 px-2 py-1 font-mono text-[10px] text-blue-400">
      ...
      <div className="space-y-3 bg-[#09090B]/40 p-4">
        <label
        ...
        <input
          ...
          className="w-full rounded-lg border border-white/10 bg-obsidian/80 px-3.5 py-2.5 font-mono text-xs text-slate-100 placeholder:text-slate-dim outline-none transition focus:border-blue-500/40 focus:ring-1 focus:ring-blue-500/30"
        />
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-blue-500/40 bg-blue-500/15 px-3 py-2 text-xs font-semibold text-blue-400 transition hover:bg-blue-500/25 disabled:cursor-not-allowed disabled:opacity-40"
          >
            {savedFlash ? (
