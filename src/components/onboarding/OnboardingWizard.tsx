      ...
      {open ? (
        <div className="fixed inset-0 z-[80] flex justify-end" role="presentation">
          ...
          <motion.aside
            ...
            className="relative z-10 flex h-full w-full max-w-md flex-col border-l border-white/10 bg-[#09090B]/95 shadow-[0_0_64px_rgba(16,185,129,0.12)] backdrop-blur-xl"
          >
                ...
                {[1, 2, 3].map((n) => (
                  <div
                    ...
                    className={`h-1 flex-1 rounded-full transition ${
                      n <= step ? "bg-emerald-500" : "bg-white/10"
                    }`}
                  />
                ))}
              </div>
            ...
            <footer className="flex items-center gap-2 border-t border-white/10 px-5 py-4">
              ...
              {step < 3 ? (
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-4 py-2.5 text-xs font-semibold text-[#09090B] transition hover:bg-emerald-400 disabled:cursor-not-allowed disabled:opacity-40"
                >
                  Continue
                ...
                <button
                  ...
                  disabled={claiming}
                  onClick={finish}
                  className="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-4 py-2.5 text-xs font-semibold text-[#09090B] transition hover:bg-emerald-400 disabled:opacity-60"
                >
