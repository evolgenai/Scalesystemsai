...
> = {
  idle: "",
  running:
    "blueprint-node-running border-emerald-400/70 shadow-[0_0_32px_rgba(52,211,153,0.45),0_0_16px_rgba(34,211,238,0.25)] ring-2 ring-cyan-accent/40",
  paused:
...
export default function BlueprintNodeShell({
  ...
  return (
    ...
    >
      ...
      {status === "done" ? (
        <span
          className="absolute -right-2 -top-2 z-[1] flex h-6 w-6 items-center justify-center rounded-full border border-emerald-400/50 bg-emerald-500 text-white shadow-[0_0_14px_rgba(16,185,129,0.85)]"
      ...
      {showTarget ? (
        <Handle
          ...
          className="!h-2.5 !w-2.5 !border-0 !bg-emerald-400 !shadow-[0_0_8px_rgba(52,211,153,0.9)]"
        />
      ) : null}
      {showSource ? (
        <Handle
