  ...
  return (
    <g className={active ? "blueprint-edge-active" : undefined}>
      <BaseEdge
        ...
        style={{
          ...style,
          stroke: active ? "#34d399" : "rgba(16,185,129,0.45)",
          strokeWidth: active ? 2.5 : 1.75,
          filter: active
            ? "drop-shadow(0 0 6px rgba(52,211,153,0.85))"
            : "drop-shadow(0 0 3px rgba(16,185,129,0.35))",
        }}
      />
      {active ? (
        <>
          <circle r="3.5" fill="#6ee7b7" className="blueprint-particle">
            <animateMotion dur="1.4s" repeatCount="indefinite" path={edgePath} />
          </circle>
          <circle r="2" fill="#a7f3d0" className="blueprint-particle-trail">
            <animateMotion
              dur="1.4s"
              begin="0.35s"
