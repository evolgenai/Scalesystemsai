      ...
      ? createPortal(
          <div className="fixed inset-0 z-[80] flex justify-end">
            ...
            <aside
              ...
              className="relative z-10 flex h-full w-full max-w-md flex-col border-l border-white/10 bg-[#040907]/95 shadow-[-24px_0_60px_rgba(0,0,0,0.55)] backdrop-blur-2xl"
            >
      ...
      ? createPortal(
          <div className="fixed inset-0 z-[80] flex justify-end">
            ...
            <aside
              ...
              className="relative z-10 flex h-full w-full max-w-lg flex-col border-l border-white/10 bg-[#040907]/95 shadow-[-24px_0_60px_rgba(0,0,0,0.55)] backdrop-blur-2xl"
            >
              <header className="flex items-start justify-between gap-3 border-b border-white/5 px-5 py-4">
